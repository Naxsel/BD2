...
public class InsertarDatos {
    ...
    public static void crearInsertarDatos(ObjectContainer db){
        ...
        InsertarDatos.almacenarOperacion(db,op4);
        InsertarDatos.almacenarOperacion(db,op5);
        InsertarDatos.almacenarOperacion(db,op6);
        InsertarDatos.almacenarOperacion(db,op7);
        InsertarDatos.almacenarOperacion(db,op8);
        InsertarDatos.almacenarOperacion(db,op9);
        InsertarDatos.almacenarOperacion(db,op10);
        InsertarDatos.almacenarOperacion(db,op11);
        InsertarDatos.almacenarOperacion(db,op12);
        InsertarDatos.almacenarOperacion(db,op13);
        InsertarDatos.almacenarOperacion(db,op14);
        InsertarDatos.almacenarOperacion(db,op15);
        InsertarDatos.almacenarOperacion(db,op16);
        InsertarDatos.almacenarOperacion(db,op17);
        InsertarDatos.almacenarOperacion(db,op18);
        InsertarDatos.almacenarOperacion(db,op19);
        InsertarDatos.almacenarOperacion(db,op20);
        InsertarDatos.almacenarOperacion(db,op21);
        InsertarDatos.almacenarOperacion(db,op22);
        InsertarDatos.almacenarOperacion(db,op23);
        InsertarDatos.almacenarOperacion(db,op24);
        InsertarDatos.almacenarOperacion(db,op25);
        InsertarDatos.almacenarOperacion(db,op26);
        InsertarDatos.almacenarOperacion(db,op27);
        InsertarDatos.almacenarOperacion(db,op28);
        InsertarDatos.almacenarOperacion(db,op29);
        InsertarDatos.almacenarOperacion(db,op30);
        InsertarDatos.almacenarOperacion(db,op31);
        InsertarDatos.almacenarOperacion(db,op32);
        InsertarDatos.almacenarOperacion(db,op33);
        InsertarDatos.almacenarOperacion(db,op34);
        InsertarDatos.almacenarOperacion(db,op35);
        InsertarDatos.almacenarOperacion(db,op36);
        InsertarDatos.almacenarOperacion(db,op37);
        InsertarDatos.almacenarOperacion(db,op38);
        InsertarDatos.almacenarOperacion(db,op39);
        InsertarDatos.almacenarOperacion(db,op40);
        InsertarDatos.almacenarOperacion(db,op41);
        InsertarDatos.almacenarOperacion(db,op42);
        InsertarDatos.almacenarOperacion(db,op43);
        InsertarDatos.almacenarOperacion(db,op44);
        InsertarDatos.almacenarOperacion(db,op45);
        InsertarDatos.almacenarOperacion(db,op46);
        InsertarDatos.almacenarOperacion(db,op47);
        InsertarDatos.almacenarOperacion(db,op48);
        InsertarDatos.almacenarOperacion(db,op49);
        InsertarDatos.almacenarOperacion(db,op50);
        InsertarDatos.almacenarOperacion(db,op51);
        InsertarDatos.almacenarOperacion(db,op52);
        InsertarDatos.almacenarOperacion(db,op53);
        ...
        InsertarDatos.almacenarCuenta(db,c4);
        InsertarDatos.almacenarCuenta(db,c5);
        InsertarDatos.almacenarCuenta(db,c6);
        InsertarDatos.almacenarCuenta(db,c7);
        InsertarDatos.almacenarCuenta(db,c8);
        InsertarDatos.almacenarCuenta(db,c9);
        InsertarDatos.almacenarCuenta(db,c10);
        InsertarDatos.almacenarCuenta(db,c11);
        InsertarDatos.almacenarCuenta(db,c12);
        InsertarDatos.almacenarCuenta(db,c13);
        InsertarDatos.almacenarCuenta(db,c14);
        InsertarDatos.almacenarCuenta(db,c15);
        InsertarDatos.almacenarCuenta(db,c16);
        InsertarDatos.almacenarCuenta(db,c17);
        InsertarDatos.almacenarCuenta(db,c18);
        InsertarDatos.almacenarCuenta(db,c19);
        InsertarDatos.almacenarCuenta(db,c20);
        InsertarDatos.almacenarCuenta(db,c21);
        InsertarDatos.almacenarCuenta(db,c22);
        ...
        InsertarDatos.almacenarOficina(db,o3);
        InsertarDatos.almacenarOficina(db,o4);
        InsertarDatos.almacenarOficina(db,o5);
        InsertarDatos.almacenarOficina(db,o6);
        InsertarDatos.almacenarOficina(db,o7);
        InsertarDatos.almacenarOficina(db,o8);
        InsertarDatos.almacenarOficina(db,o9);
        InsertarDatos.almacenarOficina(db,o10);
        InsertarDatos.almacenarOficina(db,o11);
        InsertarDatos.almacenarOficina(db,o12);
        InsertarDatos.almacenarOficina(db,o13);
        InsertarDatos.almacenarOficina(db,o14);
        InsertarDatos.almacenarOficina(db,o15);
        InsertarDatos.almacenarOficina(db,o16);
        InsertarDatos.almacenarOficina(db,o17);
        InsertarDatos.almacenarOficina(db,o18);
        InsertarDatos.almacenarOficina(db,o19);
        InsertarDatos.almacenarOficina(db,o20);
        InsertarDatos.almacenarOficina(db,o21);
        InsertarDatos.almacenarOficina(db,o22);
        InsertarDatos.almacenarOficina(db,o23);
        InsertarDatos.almacenarOficina(db,o24);
        InsertarDatos.almacenarOficina(db,o25);
        InsertarDatos.almacenarOficina(db,o26);
        InsertarDatos.almacenarOficina(db,o27);
        InsertarDatos.almacenarOficina(db,o28);
        InsertarDatos.almacenarOficina(db,o29);
        InsertarDatos.almacenarOficina(db,o30);
        InsertarDatos.almacenarOficina(db,o31);
        InsertarDatos.almacenarOficina(db,o32);
        InsertarDatos.almacenarOficina(db,o33);
        InsertarDatos.almacenarOficina(db,o34);
        InsertarDatos.almacenarOficina(db,o35);
        InsertarDatos.almacenarOficina(db,o36);
        InsertarDatos.almacenarOficina(db,o37);
        InsertarDatos.almacenarOficina(db,o38);
        InsertarDatos.almacenarOficina(db,o39);
        InsertarDatos.almacenarOficina(db,o40);
        InsertarDatos.almacenarOficina(db,o41);
        InsertarDatos.almacenarOficina(db,o42);
        InsertarDatos.almacenarOficina(db,o43);
        InsertarDatos.almacenarOficina(db,o44);
        InsertarDatos.almacenarOficina(db,o45);
        InsertarDatos.almacenarOficina(db,o46);
        InsertarDatos.almacenarOficina(db,o47);
        InsertarDatos.almacenarOficina(db,o48);
        InsertarDatos.almacenarOficina(db,o49);
        InsertarDatos.almacenarOficina(db,o50);
        InsertarDatos.almacenarOficina(db,o51);
        InsertarDatos.almacenarOficina(db,o52);
        InsertarDatos.almacenarOficina(db,o53);
        InsertarDatos.almacenarOficina(db,o54);
        InsertarDatos.almacenarOficina(db,o55);
        InsertarDatos.almacenarOficina(db,o56);
        InsertarDatos.almacenarOficina(db,o57);
        InsertarDatos.almacenarOficina(db,o58);
        InsertarDatos.almacenarOficina(db,o59);
        InsertarDatos.almacenarOficina(db,o60);
        InsertarDatos.almacenarOficina(db,o61);
        InsertarDatos.almacenarOficina(db,o62);
        InsertarDatos.almacenarOficina(db,o63);
        InsertarDatos.almacenarOficina(db,o64);
        InsertarDatos.almacenarOficina(db,o65);
        InsertarDatos.almacenarOficina(db,o66);
        InsertarDatos.almacenarOficina(db,o67);
        InsertarDatos.almacenarOficina(db,o68);
        InsertarDatos.almacenarOficina(db,o69);
        InsertarDatos.almacenarOficina(db,o70);
        InsertarDatos.almacenarOficina(db,o71);
        InsertarDatos.almacenarOficina(db,o72);
        InsertarDatos.almacenarOficina(db,o73);
        InsertarDatos.almacenarOficina(db,o74);
        InsertarDatos.almacenarOficina(db,o75);
        InsertarDatos.almacenarOficina(db,o76);
        InsertarDatos.almacenarOficina(db,o77);
        InsertarDatos.almacenarOficina(db,o78);
        InsertarDatos.almacenarOficina(db,o79);
        InsertarDatos.almacenarOficina(db,o80);
        InsertarDatos.almacenarOficina(db,o81);
        InsertarDatos.almacenarOficina(db,o82);
        InsertarDatos.almacenarOficina(db,o83);
        InsertarDatos.almacenarOficina(db,o84);
        InsertarDatos.almacenarOficina(db,o85);
        InsertarDatos.almacenarOficina(db,o86);
        InsertarDatos.almacenarOficina(db,o87);
        InsertarDatos.almacenarOficina(db,o88);
        InsertarDatos.almacenarOficina(db,o89);
        InsertarDatos.almacenarOficina(db,o90);
        InsertarDatos.almacenarOficina(db,o91);
        InsertarDatos.almacenarOficina(db,o92);
        InsertarDatos.almacenarOficina(db,o93);
        InsertarDatos.almacenarOficina(db,o94);
        InsertarDatos.almacenarOficina(db,o95);
        InsertarDatos.almacenarOficina(db,o96);
